...
def test_math_add():
    ...
    assert 10_000_300 + 20.3 == execute_intent('add 10,000,300 and 20.3')
    assert 10_000_000 + 300 + 20.3 == execute_intent('add 10,000,000, 300, and 20.3')
    assert 100_000 + 300 + 20.3 == execute_intent('add 1e5, 300, and 20.3')
